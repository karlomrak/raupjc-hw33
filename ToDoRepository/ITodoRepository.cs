...
namespace ToDoRepository
{
    public interface ITodoRepository
    {
        ...
        /// <summary>
        /// Tries to remove a TodoItem with given id from the database . Throw  TodoAccessDeniedException with appropriate message
        ...
        /// the owner of the Todo item/// </summary >
       ...
       bool AddLabel(string label, Guid itemId);
    }
}